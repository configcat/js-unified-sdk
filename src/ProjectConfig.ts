...
import { ensurePrototype, hasOwnProperty, isArray, isBoolean, isInteger, isIntegerInRange, isNumber, isObject, isString, setPrototypeOf } from "./Utils";
...
export function getConfigJsonSalt(setting: Setting): string {
  return setting["_configJsonSalt"] ?? throwInvalidConfigModelError("Config JSON salt is missing.");
}

export function ensureComparisonValue<T>(comparisonValue: T | null | undefined): T {
